...
namespace JsonDataMaker.Core.Tests.Parsers
{
    public class GW0029RequestCsvParserTests
    {
        ...
        {
            // ヘッダ部
            yield return "FileId,shohinShubetsu,nyukinKozaTemban,nyukinKozaKamokuCode,nyukinKozabango,teikiTemban,teikiKamokuCode,teikiKamokuCodechiwake,teikiKozabango,yonyuBango,uketsukeKingaku,kakuninJikkoKubun,shiharaibi,keiyakushaId";
            // データ部
