...
using BankVision.WebAPI.Models.GW0030;
...
namespace JsonDataMaker.Core.Tests.Parsers
{
    public class GW0030RequestCsvParserTests
    {
        ...
        {
            // ヘッダ部
            yield return "FileId,shohinShubetsu,nyukinKozaTemban,nyukinKozaKamokuCode,nyukinKozabango,teikiTemban,teikiKamokuCode,teikiKamokuCodechiwake,teikiKozabango,uketsukeKingaku,kakuninJikkoKubun,shiharaibi";
            // データ部
